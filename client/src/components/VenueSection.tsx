...
import ceremonyImage from '@assets/church_1761631500640.jpg';
import receptionImage from '@assets/reception_1761631500643.png';
  ...
  const venues = [
    {
      ...
      image: ceremonyImage,
      mapUrl: 'https://maps.app.goo.gl/x38iC6YnCfHYdACR6',
    ...
    },
    {
      ...
      mapUrl: 'https://maps.app.goo.gl/4EYSvAFD96Ws5TPc7',
    ...
    >
      ...
      <div className="space-y-20 max-w-6xl mx-auto">
        {venues.map((venue, index) => (
          <motion.div 
            key={index}
            className="border border-gold/30 rounded-3xl overflow-hidden shadow-lg bg-card"
